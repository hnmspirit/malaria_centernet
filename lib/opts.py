...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--num_workers', type=int, default=2, help='dataloader threads. 0 for single-thread.')
        ...
        # model
        self.parser.add_argument('--arch', default='res18prm')
        ...
        self.parser.add_argument('--lr_step', type=str, default='50,70', help='drop learning rate by 10.')
